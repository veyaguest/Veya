...
ITEMS: dict[str, ExpenseItem] = {i.key: i for i in (
    ...
    # ── מוזיקה והפקה ─────────────────────────────────────────────────
    _i("dj", "DJ"),
    # פריט אחד לשתי רכישות שכמעט תמיד מגיעות מאותו ספק. מי שקיבל שתי
    # הצעות נפרדות עדיין מוצא "תאורה" ו"הגברה" בנפרד תחת "הוספת הוצאה" —
    # האיחוד מקצר את המסך, הוא לא מוחק את השליטה.
    _i("sound_lighting", "תאורה והגברה"),
    ...
    _i("design_flowers", "עיצוב ופרחים"),
    _i("chuppah", "חופה"),
    _i("flowers", "פרחים"),
    _i("balloons", "בלונים"),
    ...
    _i("guest_stations", "עמדות לאורחים"),
    _i("show", "מופע"),
...
_TEMPLATE_SPECS: dict[str, tuple[_Cat, ...]] = {
    ...
    "wedding": (
        ...
        ("music", "מוזיקה והפקה",
         ["dj", "sound_lighting"],
         ["sound", "lighting", "band", "singer", "screens", "stage", "tech_gear",
          "effects"]),
        ("photo", "צילום",
         ["photo_video"],
         ["photo_stills", "video", "drone", "magnets", "albums", "parent_albums",
          "pre_shoot", "clip", "second_shooter"]),
        ("design", "עיצוב ופרחים",
         ["chuppah", "design_flowers"],
         ["flowers", "venue_design", "table_design", "centerpieces",
          "reception_design", "bar_design"]),
        ("attire", "כלה וחתן",
         ["dress", "suit", "hair_makeup"],
         ["makeup", "hair", "second_dress", "shoes", "jewelry", "accessories",
          "alterations", "extra_outfit"]),
        ("ceremony", "טקס",
         ["rabbi", "rings"],
         ["ketubah", "tallit", "ceremony_items", "file_opening", "fees"]),
        ("guests", "הזמנות ומיתוג",
         ["invitations"],
         ["digital_invite", "branding", "table_numbers", "seating_cards",
          "signage", "guest_gifts"]),
        # §2 — אטרקציות כקטגוריה ראשית ולא כפריט בודד תחת "אורחים".
        # בחתונה ישראלית זו שורת תקציב בפני עצמה, לא תוספת.
        ("attractions", "אטרקציות",
         [],
         ["attractions", "guest_stations", "fireworks", "dancers", "photo_booth",
          "show"]),
        ("logistics", "הסעות ולוגיסטיקה",
         ["tips"],
         ["shuttles", "parking", "lodging", "security", "event_manager", "staff",
          "equipment", "car"]),
        # §2 — קטגוריה גנרית לכל מה שלא נמצא ברשימה. אחרונה בכוונה:
        # היא הרשת, לא נקודת הפתיחה.
        ("other", "שונות",
         [],
         ["misc", "other"]),
    ),
    ...
    "henna": (
        ...
        ("music", "מוזיקה והפקה",
         ["dj", "sound_lighting"],
         ["sound", "lighting", "band", "stage", "screens"]),
        ("photo", "צילום",
         ["photo_video"],
         ["photo", "video", "magnets", "albums"]),
        ("design", "עיצוב ופרחים",
         ["table_design", "flowers"],
         ["entrance_design", "branding"]),
        ("guests", "הזמנות ומיתוג",
         ["invitations"],
         ["signage", "guest_gifts", "keepsakes"]),
        ("attractions", "אטרקציות",
         [],
         ["attractions", "dancers", "guest_stations", "show"]),
        ("logistics", "הסעות ולוגיסטיקה",
         ["tips"],
         ["shuttles", "parking", "staff", "equipment"]),
        ("other", "שונות",
         [],
         ["misc", "other"]),
    ),
    ...
    "bar_mitzvah": (
        ...
        ("music", "מוזיקה והפקה",
         ["dj", "sound_lighting"],
         ["sound", "lighting", "screens", "stage"]),
        ("photo", "צילום",
         ["photo_video", "magnets"],
         ["photo", "video", "albums", "kid_shoot"]),
        ("attractions", "אטרקציות",
         ["attractions"],
         ["games", "activity_stations", "guest_stations", "dancers", "show",
          "photo_booth"]),
        ("design", "עיצוב ופרחים",
         ["concept_design", "balloons"],
         ["flowers", "table_design", "branding"]),
        ("celebrant", "החוגג והמשפחה",
         ["suit", "tefillin", "lessons"],
         ["shoes", "accessories", "tallit", "rabbi", "cantor"]),
        ("guests", "הזמנות ומיתוג",
         ["invitations"],
         ["signage", "keepsakes", "guest_gifts"]),
        ("logistics", "הסעות ולוגיסטיקה",
         ["tips"],
         ["shuttles", "parking", "staff", "equipment"]),
        ("other", "שונות",
    ...
    "bat_mitzvah": (
        ...
        ("music", "מוזיקה והפקה",
         ["dj", "sound_lighting"],
         ["sound", "lighting", "stage", "screens"]),
        ("photo", "צילום",
         ["photo_video", "magnets"],
         ["photo", "video", "albums", "kid_shoot"]),
        ("attractions", "אטרקציות",
         ["activity_stations"],
         ["attractions", "guest_stations", "dancers", "show", "games",
          "photo_booth"]),
        ("design", "עיצוב ופרחים",
         ["concept_design", "balloons"],
         ["flowers", "table_design", "branding"]),
        ("celebrant", "החוגגת",
         ["dress", "hair_makeup"],
         ["makeup", "hair", "shoes", "jewelry", "accessories"]),
        ("guests", "הזמנות ומיתוג",
         ["invitations"],
         ["signage", "keepsakes", "guest_gifts"]),
        ("logistics", "הסעות ולוגיסטיקה",
    ...
    "brit": (
        ...
        ("design", "עיצוב ופרחים",
         ["flowers", "balloons"],
         ["venue_design", "table_design"]),
        ("baby", "התינוק",
         ["baby_outfit"],
         ["accessories"]),
        ("guests", "הזמנות ומיתוג",
         ["invitations"],
         ["branding", "signage", "keepsakes", "guest_gifts"]),
        ("music", "מוזיקה",
         [],
         ["music", "dj", "sound"]),
        ("logistics", "הסעות ולוגיסטיקה",
...
_LEGACY_LABELS: dict[str, str] = {
    ...
    "tips": "טיפים",
    # ``other`` הוסר מכאן ב-2026-09: הוא קטגוריה אמיתית ("שונות") בכל
    # שבעת הסוגים, ו-``category_label`` מוצאת אותו ב-``_LABELS`` לפני
    # שהיא מגיעה לכאן.
    "attractions_old": "אטרקציות",
}
