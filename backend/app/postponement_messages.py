...
#:
#: ``event_type_definite`` ולא ``event_type``: הנוסחים משתמשים בשם האירוע
#: כנושא המשפט ("החתונה שלנו נדחה"), והצורה הסתמית הייתה נותנת "חתונה שלנו
#: נדחה". החלפת שם ה-placeholder אושרה ע"י הבעלים (2026-08-25) — **מילות
#: הנוסח עצמן לא שונו.**
VARIABLES = ["guest_name", "event_type_definite", "host_names"]
...
#: ``{{event_type_definite}}`` ועל ``{{host_names}}``, ומנוע המונחים ממלא את השאר.
#: אירוע שנדחה הוא אירוע שנדחה, בכל סוג.
EVENT_TYPES = list(event_terms.EVENT_TERMS)
...
OPTIONS: list[dict] = [
    {
        ...
        "content": (
            "שלום {{guest_name}} ❤️\n"
            "\n"
            "עדכון חשוב — {{event_type_definite}} שלנו נדחה.\n"
    ...
    },
    {
        ...
        "content": (
            "שלום {{guest_name}} ❤️\n"
            "\n"
            "רצינו לעדכן אותך ש{{event_type_definite}} שלנו נדחה.\n"
    ...
    },
    {
        ...
        "content": (
            "שלום {{guest_name}} ❤️\n"
            "\n"
            "לצערנו, {{event_type_definite}} שלנו נדחה.\n"
    ...
    },
    {
        ...
        "content": (
            "שלום {{guest_name}},\n"
            "\n"
            "רצינו לעדכן אותך כי {{event_type_definite}} שלנו נדחה.\n"
