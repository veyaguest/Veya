...
function calcVenueCommitment() {
  const faq = [
    ...
    {
      q: 'למה אורח נוסף עולה לפעמים 0 ₪?',
      a: 'כל עוד מספר המגיעים נמוך מכמות ההתחייבות, אתם כבר משלמים על המקום שלו. רק מהרגע שעוברים את ההתחייבות כל אורח נוסף נספר במחיר מלא. אם יש לכם הוצאות נוספות לאדם, כמו אלכוהול, הן כן מתווספות גם מתחת להתחייבות.',
    },
    {
  ...
  const body = `${pageHero({
    eyebrow: 'מחשבון',
    h1: 'התחייבות לאולם — על כמה אתם באמת משלמים',
    lead: 'מזינים כמה אישרו הגעה, על כמה התחייבתם בחוזה ומה מחיר המנה. המחשבון מראה על כמה מנות מחייבים אתכם בפועל, וכמה מוסיף כל אורח נוסף.',
        ...
        <div class="wrap">
            ...
            <form class="calc-form" id="f" novalidate>
              ...
              <label class="calc-field">
                <span>עוד הוצאות לאדם, בשקלים
                  <span class="hint">אלכוהול, מתנה לאורח — כל מה שמשולם לפי ראש ואינו כלול במנה.</span>
                </span>
              ...
              <label class="calc-field">
                <span>הוצאות קבועות, בשקלים
                  <span class="hint">צילום, מוזיקה, עיצוב — לא זזות עם מספר המגיעים, אבל משנות את העלות לאורח.</span>
                </span>
          ...
          <article class="article" style="margin-top:56px">
            ...
            <p>
              ...
              <strong>כמה עולה עוד אורח?</strong> מתחת להתחייבות התשובה היא לרוב 0 ₪ על
...
${faqHtml(faq)}
  ...
  const script = `      var f = document.getElementById('f'), out = document.getElementById('out'), err = document.getElementById('err');
      ...
      function render(d) {
        ...
        if (d.committed_quantity && d.unused_quantity > 0) {
          ...
          head = 'משלמים על ' + d.billed_quantity + ' מנות';
          note = 'עברתם את ההתחייבות ב-' + d.over_commitment + ' אנשים. מכאן כל אורח נספר במחיר מלא.';
        } else {
          head = 'משלמים על ' + d.billed_quantity + ' מנות';
  ...
  return page({
    ...
    description:
      'מחשבון התחייבות לאולם: כמה מנות מחייבים אתכם בפועל כשמגיעים פחות ממה שהתחייבתם, וכמה מוסיף כל אורח נוסף. אותו חישוב שרץ בתוך VEYA.',
    trail: [{ name: 'VEYA', url: '/' }, { name: 'מחשבונים', url: '/calculators/' }, { name: 'התחייבות לאולם' }],
    faq,
    schema: [
      {
  ...
  const faq = [
    {
      ...
      a: 'את עלות האירוע לפי סעיפי ההוצאה שהזנתם ומספר המגיעים בפועל, את ההתחייבות מול הספק, את העלות הממוצעת לאורח, את מה שהתקבל במתנות אחרי האירוע, ואת ההפרש ביניהם.',
    },
    {
        ...
        <div class="wrap">
          <div class="section-head">
            ...
            <p class="section-sub">
              ...
              לאורח, והתשובה לשאלה כמה מוסיף אורח נוסף.
            </p>
          </div>
        ...
        <div class="wrap">
          ...
          <div class="steps-two">
            <div class="step-two">
              ...
              <p>אורח נוסף לא מוסיף על המנה. רק הוצאות אחרות לאדם, אם יש.</p>
            </div>
            <div class="step-two">
              <span class="lbl">מעל ההתחייבות</span>
              <span class="big">מחיר מנה מלא</span>
              <p>מכאן כל אורח נספר במלוא המחיר. זו המדרגה שמשנה את החשבון.</p>
            </div>
          </div>
        ...
        <div class="wrap">
          ...
          <div class="numcard">
            ...
            <dl>
              ...
              <div class="numrow"><dt>עלות בפועל לאורח</dt><dd>על כל ההוצאות, לא רק המנה</dd></div>
