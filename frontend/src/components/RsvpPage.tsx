...
const RSVP_FAQ: { q: string; a: string }[] = [
  ...
  },
  {
    ...
    a: 'הוא ממשיך לקבל תזכורות לפי לוח הזמנים. מי שלא ענה אחרי כל התזכורות עובר לרשימת מעקב טלפוני, כדי שתוכלו להתקשר אישית לפני שסוגרים מספר סופי.',
  },
  {
  ...
  },
  {
    ...
    a: 'בנינו לכם לוח זמנים שמסתיים במועד סגירת הרשימה, עם תזכורות אוטומטיות ורשימת מעקב טלפוני למי שלא ענה — כדי שתגיעו לאותו יום עם מספר סופי וברור, בלי לרדוף אחרי אף אחד בעצמכם.',
  },
]
    ...
    <div className="track-status">
      ...
      {track.phone_list.length > 0 && (
        <div className="track-phone">
          ...
          <span className="clar-sub">
            מוזמנים שממתינים לתשובה אחרי כל התזכורות — כדאי טלפון אישי.
          </span>
