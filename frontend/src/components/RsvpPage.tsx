  ...
  return (
    <div className="rsvp-page couple-rsvp">
      ...
      {!active ? (
        ...
        /* אחרי השליחה — נפתחת חוויית אישורי ההגעה המלאה. מסך "ניהול הודעות"
           (CommunicationTab) כבר מחולק פנימית לשלוש שכבות ברורות משלו
           (לוח הודעות / מעקב / נוסחים — ראו messageShared.tsx), ולכן אין
           צורך בעטיפת קיבוץ נוספת כאן — רק להזין אותו עם track/onResend
           כדי שטאב "מעקב" הפנימי שלו יעבוד. */
        <div className="rsvp-layer">
          ...
          <RsvpTimeline />
          <div id="mb-anchor">
            <CommunicationTab track={track ?? undefined} onResend={openSendDialog} />
          </div>
        </div>
      )}
