                ...
                <div className="hm-demo" aria-hidden="true">
                  <div className="hm-demo-frame">
                    <div className="hm-demo-world">
                      ...
                      <span className="hm-demo-hand" />
                    </div>
                    <span className="hm-demo-badge">הכול נשאר גלוי</span>
                  </div>
                </div>

                {/* קודם: כותרת "איך זה עובד?", שלוש נקודות, "טיפ קטן" ומשפט סיום —
                    חמש פעמים אותו רעיון. משפט אחד אומר את זה. */}
                <p className="hm-guide-hint">
                  אין צורך בזום או בגלילה: המפה מתאימה את עצמה לבד, כך שכל האולם
                  תמיד מולכם.
                </p>
