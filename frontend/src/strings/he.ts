...
export const strings = {
  ...
  //
  //  ⚠️ שני כללי לקסיקון שהמסך הזה חי בהם:
  //  1. **"מגיעים" ולא "אורחים".** "מוזמנים" הוא מי שקיבל הזמנה;
  ...
  //  2. **שם האירוע דרך הלקסיקון.** "כספי החתונה" נבנה כ-
  //     `כספי ${terms.eventNoun}` ולא נכתב קשיח — אחרת ברית ואירוע
  //     עסקי היו מקבלים כותרת חתונתית.
  // ========================================================================
  finance: {
    // ---- ניווט וכותרות ----
    // נבנות מהלקסיקון: "כספי החתונה" / "כספי הברית" / "כספי האירוע".
    navTitle: (eventNoun: string) => `כספי ${eventNoun}`,
    navShort: 'כספים',
