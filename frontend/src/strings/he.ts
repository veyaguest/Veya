...
export const strings = {
  ...
  payout: {
    ...
    subtitle: 'לאן להעביר את המתנות שהתקבלו',

    // מצב ריק — לפני שהוזנו פרטים.
    emptyTitle: 'עוד לא הוספתם פרטי חשבון',
    emptyBody: 'כדי שנוכל להעביר אליכם את המתנות, נצטרך את פרטי החשבון ואישור ניהול חשבון.',
    ...
    updatedAt: (when: string) => `עודכן ב-${when}`,
    ...
    errors: {
      ...
      loadFailed: 'לא הצלחנו לטעון את פרטי החשבון, ננסה שוב',
